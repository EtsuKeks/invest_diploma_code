...
class BlackSholesInitialAccuracyCheckRunner(Runner):
    def __init__(self):
...
# Run with "python -m src.runners.bs.bs_initial_accuracy_check"
if __name__ == "__main__":
    ...
    print_max_abs(df["close_rel_diff_acc"], df, "close_rel_diff_acc")
    print_max_abs(df["close_rel_diff_inacc"], df, "close_rel_diff_inacc")
